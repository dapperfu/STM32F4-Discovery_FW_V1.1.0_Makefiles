...
// JEK -> The STM32F Discovery board uses a 8MHz crystal instead of the 
// assumed 25MHz.

//#define PLL_M      25     // Values for 25MHz.
//#define PLL_N      336

// JEK -> The actual HSE is 8MHz, not 25MHz, so the following values crank the HSE to 168MHz.
#define PLL_M      10
#define PLL_N      420
