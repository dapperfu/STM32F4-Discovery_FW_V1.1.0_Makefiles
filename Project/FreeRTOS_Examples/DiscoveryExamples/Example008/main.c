/*
    ...
    This is example #8 from the book Using the FreeRTOS Real Time Kernel - A Practical Guide
...
int main(void)
{
	...
	is also set to NULL. */
	xTaskCreate(vTask1, (const signed char * const)"Task 1", 240, NULL, 2, NULL);
	...
	xTaskCreate(vTask2, (const signed char * const)"Task 2", 240, NULL, 1, &xTask2Handle);
