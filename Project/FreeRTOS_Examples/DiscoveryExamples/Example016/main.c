/*
    ...
    This is example #16 from the book Using the FreeRTOS Real Time Kernel - A Practical Guide
...
int main(void)
{
	...
	if(xPrintQueue != NULL)
	{
		...
		xTaskCreate((pdTASK_CODE)prvPrintTask, (const signed char * const)"Print1", (unsigned short)240, (void *) 0, (unsigned portBASE_TYPE)1, (xTaskHandle)NULL);
		xTaskCreate((pdTASK_CODE)prvPrintTask, (const signed char * const)"Print2", (unsigned short)240, (void *) 1, (unsigned portBASE_TYPE)2, (xTaskHandle)NULL);

		/* Create the gatekeeper task.  This is the only task that is permitted
		to access standard out. */
		xTaskCreate(prvStdioGatekeeperTask, (const signed char * const)"Gatekeeper", (unsigned short)240, (void *)NULL, (unsigned portBASE_TYPE)0, (xTaskHandle)NULL);
